    ...
    <div class="container">
        <div class="p-5">
            ...
            <div class="gap-2 d-flex justify-content-start mb-3">
                ...
                data-mdb-toggle="modal" data-mdb-target="#formUpdate" 
                data-te-ripple-init data-te-ripple-color="light"
                 class="inline-flex items-center rounded bg-primary px-4 pt-[6px] pb-[5px] text-sm font-medium leading-normal text-white shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out hover:bg-primary-600 hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:bg-primary-600 focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:outline-none focus:ring-0 active:bg-primary-700 active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)]">
                            ...
                            <div class="col-3">
                                <div class="form-group">
                                    ...
                                    <div class="flex gap-2">
                                        <button type="submit" class="btn btn-primary btn-sm flex items-center text-capitalize shadow-0">
                                            <span class="material-icons-sharp text-base">
                                                search
                                            </span>
                                            <span>Tìm kiếm</span>
                                        </button>
                                        <button @click="resetSearch()" class="max-h-[38px] inline-flex items-center rounded bg-[#ffffff] border border-primary-100 py-2 px-2 text-sm font-medium leading-normal text-dark-700 transition duration-150 ease-in-out hover:border-primary-accent-100 hover:bg-neutral-500 hover:bg-opacity-10 focus:border-primary-accent-100 focus:outline-none focus:ring-0 active:border-primary-accent-200 dark:text-primary-100 dark:hover:bg-neutral-100 dark:hover:bg-opacity-10">
